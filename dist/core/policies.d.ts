...
export declare function runWithRetry<T>(fn: () => Promise<T>, telemetry?: TelemetrySink, intentName?: string, stepId?: string, policy?: RetryPolicy): Promise<T>;
export declare function runWithTimeout<T>(fn: () => Promise<T>, timeoutMs?: number, telemetry?: TelemetrySink, intentName?: string, stepId?: string): Promise<T>;
