 ...
 */
import type { Intent, IntentConfig } from "../types";
export declare function defineIntent<Input = unknown, Output = unknown>(config: IntentConfig<Input, Output>): Intent<Input, Output>;
