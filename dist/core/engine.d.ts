 ...
 */
import type { Intent, ExecutionContext, ExecutionResult } from "../types";
export declare function runIntent<Input, Output>(intent: Intent<Input, Output>, ctx: ExecutionContext<Input>): Promise<ExecutionResult<Output>>;
