...
export interface Intent<Input = unknown, Output = unknown> extends IntentConfig<Input, Output> {
}
...
export interface TelemetryEvent {
    type: "intent_started" | "intent_finished" | "step_started" | "step_finished" | "retry_attempt_started" | "retry_attempt_failed" | "timeout_started" | "timeout_fired" | "timeout_cleared";
    timestamp: number;
    intentName: string;
    stepId?: StepId;
    success?: boolean;
